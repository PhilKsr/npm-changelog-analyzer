  ...
  return (
    <header className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 sticky top-0 z-50 backdrop-blur-sm bg-white/95 dark:bg-gray-900/95">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400">
                  Intelligent package upgrade analysis
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="hidden md:flex items-center justify-center space-x-8 py-3 border-t border-gray-100 dark:border-gray-800">
          <div className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
            <div className="w-2 h-2 bg-green-500 rounded-full"></div>
            <span>Ready</span>
          </div>
          <div className="text-xs text-gray-500 dark:text-gray-500">
            Analyze npm package changelogs to make informed upgrade decisions
          </div>
          <div className="flex items-center space-x-2 text-xs text-gray-500 dark:text-gray-500">
            <span>Powered by</span>
            <span className="font-mono text-blue-600 dark:text-blue-400">npmjs.org</span>
            <span>+</span>
            <span className="font-mono text-blue-600 dark:text-blue-400">github.com</span>
          </div>
        </div>
      </div>
    </header>
